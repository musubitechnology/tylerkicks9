    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row gap-2">
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-byu-navy text-white rounded-md hover:bg-opacity-90 transition-all"
        >
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-byu-royal text-white rounded-md hover:bg-opacity-90 transition-all"
        >
